...
def generate_launch_description():
    ...
    ros_gz_bridge_config_file_path = 'config/gazebo_panda_controllers.yaml'
    ...
    robot_state_publisher_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_share_description, 'launch', 'description_launch.launch.py')
        ]),
        launch_arguments={
            'jsp_gui': jsp_gui,
    ...
    load_controllers_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_share_moveit, 'launch', 'moveit.launch.py')
        ]),
        launch_arguments={
            'use_sim_time': use_sim_time
        }.items(),
